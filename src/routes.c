...
static void set_navbar(template_ctx_t *ctx, http_request_t *req) {
    ...
    n = snprintf(navbar + nav_len, sizeof(navbar) - nav_len,
        ...
        "<button class=\"nav-popup-item nav-theme-item\" data-theme=\"midnight\" onclick=\"setTheme('midnight')\"><span class=\"theme-swatch\" style=\"background:#06080f;border-color:#60a5fa\"></span>Midnight</button>"
        "<button class=\"nav-popup-item nav-theme-item\" data-theme=\"daylight\" onclick=\"setTheme('daylight')\"><span class=\"theme-swatch\" style=\"background:#fdf8f0;border-color:#c2610a\"></span>Daylight</button>"
        ...
        "<button class=\"nav-popup-item nav-theme-item\" data-theme=\"obsidian\" onclick=\"setTheme('obsidian')\"><span class=\"theme-swatch\" style=\"background:#1a1625;border-color:#7c6f9e\"></span>Obsidian</button>"
        "<button class=\"nav-popup-item nav-theme-item\" data-theme=\"oled\" onclick=\"setTheme('oled')\"><span class=\"theme-swatch\" style=\"background:#000000;border-color:#00e5ff\"></span>OLED</button>"
        "<button class=\"nav-popup-item nav-theme-item\" data-theme=\"hc-light\" onclick=\"setTheme('hc-light')\"><span class=\"theme-swatch\" style=\"background:#ffffff;border-color:#000000\"></span>HC Light</button>"
        "<button class=\"nav-popup-item nav-theme-item\" data-theme=\"hc-dark\" onclick=\"setTheme('hc-dark')\"><span class=\"theme-swatch\" style=\"background:#000000;border-color:#ffffff\"></span>HC Dark</button>"
        "</div>"
        "</div>"
        "<div class=\"nav-popup-wrap\">"
