...
static void set_navbar(template_ctx_t *ctx, http_request_t *req) {
    ...
    n = snprintf(navbar + nav_len, sizeof(navbar) - nav_len,
        "<div class=\"nav-popup-menu theme-popup\" id=\"theme-dd\">"
        "<div class=\"theme-search-wrap\">"
        "<input class=\"theme-search-input\" id=\"theme-search\" type=\"text\" placeholder=\"Search themes...\" autocomplete=\"off\" oninput=\"filterThemes(this.value)\">"
        "</div>"
